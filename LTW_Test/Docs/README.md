...
| [performance-handover.md](performance-handover.md) | **TEMPORARY.** State of play and the plan for the server performance work, written across a machine change. Delete it or fold it into `multiplayer.md` once the work lands. |
...
3. **Something about the networked build** → into `multiplayer.md`.
