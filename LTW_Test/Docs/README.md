...
6. **An investigation** — measured something, chased a bug, ruled an approach out → a new
...
Anything that does not fit those six probably belongs as a comment next to the code it is
