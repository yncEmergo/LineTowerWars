...
| [multi-match-todo.md](multi-match-todo.md) | **TEMPORARY: the check pass on `multi-match.md`.** Every issue three readers found in the rewritten plan, each with its exact replacement text and with the applied ones marked. Fold it into the plan before any P2 code, then delete it. |
