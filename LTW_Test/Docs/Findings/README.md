...
| [2026-09-16-ai-phase-0-baseline.md](2026-09-16-ai-phase-0-baseline.md) | The ladder as phase 0 of the rework leaves it, so later phases have something to beat. Also what the two new exploiter profiles found on their first run: a build floor high enough to stop building also stops sending, a turtle's income never moves, and an all-in with seven towers was still ahead on lives. |
